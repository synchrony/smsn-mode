...
(if smsn-mode-map ()
  (progn
    ...
    (define-key smsn-mode-map (kbd "C-c C-t C-b a")   (smsn-visit-in-amazon 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b d")   (smsn-visit-in-delicious 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b e")   (smsn-visit-in-ebay 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b g")   (smsn-visit-in-google 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b m")   (smsn-visit-in-google-maps 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b s")   (smsn-visit-in-google-scholar 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b t")   (smsn-visit-in-twitter 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b w")   (smsn-visit-in-wikipedia 'smsn-data-focus-title))
    (define-key smsn-mode-map (kbd "C-c C-t C-b y")   (smsn-visit-in-youtube 'smsn-data-focus-title))
